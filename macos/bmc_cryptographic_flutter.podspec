...
# Run `pod lib lint bmc_cryptographic_flutter.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'bmc_cryptographic_flutter'
  s.version          = '0.0.1'
...
A new Flutter project.
  ...
  # s.resource_bundles = {'bmc_cryptographic_flutter_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
